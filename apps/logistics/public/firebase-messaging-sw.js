...
// Version: 2.0 - Logistics App - Enhanced logging and error handling
...
messaging.onBackgroundMessage((payload) => {
  ...
  try {
    const notificationTitle = payload.notification?.title || payload.data?.title || 'New Order Available!';
    const notificationBody = payload.notification?.body || payload.data?.body || 'A new order is ready for pickup nearby';
